...
function init() {
	...
	map = THREE.ImageUtils.loadTexture( 'translation.png' );
	...
	object = new THREE.Mesh( new THREE.CylinderGeometry( 200, 200, 150, 100, 1, true ), material );
